<template>
  ...
  <section class="js-work-section relative z-30 bg-white px-4 md:px-14 xl:px-30 2xl:px-40 pt-24 md:pt-45 pb-24 md:pb-40">

    <WorkTitle/>

    <ul class="flex flex-col gap-20 md:gap-28 xl:gap-70">
